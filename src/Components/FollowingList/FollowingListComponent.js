...
export default function FollowingListComponent() {
    const DATA = [
        {
          id: 'b1',
            ...
            <View style={styles.imageContainer}>
                <View style={{flexDirection:'row',alignItems:'center'}}>
                    ...
                    <View style={{marginHorizontal:10}}>
                        <Text numberOfLines={1} style={styles.name,{fontWeight:'bold'}}>{item.username}</Text>
                        <Text style={styles.name}>{item.name}</Text>
                    </View>
                </View>
                <View style={{flexDirection:'row',alignItems:'center'}}>
                    <TouchableOpacity 
                        onPress={()=>{Alert.alert('Remove','You want to remove '+item.name)}}
                        style={styles.button}>
                        <Text>Following</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
    ...
    return (
        <View>
            ...
            <View style={{flexDirection:'row',width:'90%',alignItems:'center',alignSelf:'center',marginBottom:20}}>
                ...
                img2={'Home/yashwant.jpg'} />
                    <View style={{marginHorizontal:10}}>
                        <Text style={styles.name,{fontWeight:'bold'}}>Most Shown in Feed</Text>
                        <Text>theadulthumor and 49 others</Text>
                    </View>
            </View>
